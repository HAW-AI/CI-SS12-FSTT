...
public class ParserTest {
	...
	expected = new SelectorNode(new IdentNode("ident1"), asList(
		new IntNode(-1337), new IdentNode("sel"), new IntNode(1)));
	assertEquals(expected, actual);
    }
	...
	expected = new BinOpNode(
		DIV_OP,
		new StringNode("hello wOrld"),
		new SelectorNode(new IdentNode("ident"), asList(new IntNode(7))));
	assertEquals(expected, actual);

	actual = createParser("\"hello wOrld\" / ident[7] *   9").term();
	expected = new BinOpNode(MUL_OP, new BinOpNode(DIV_OP, new StringNode(
		"hello wOrld"), new SelectorNode(new IdentNode("ident"),
		asList(new IntNode(7)))), new IntNode(9));
	assertEquals(expected, actual);
	...
	expected = new AssignmentNode(new SelectorNode(new IdentNode("ident1"),
		asList(new IdentNode("kp"), new IntNode(1),
			new IdentNode("lol"))), new IntNode(10));
	assertEquals(expected, actual);

	actual = createParser("ident1[0]:=10").assignment();
	expected = new AssignmentNode(new SelectorNode(new IdentNode("ident1"),
		asList(new IntNode(0))), new IntNode(10));
	assertEquals(expected, actual);
    }
	...
	expected = new IfStatementNode(
		...
		new IfStatementNode(new BinOpNode(LO_OP, new IntNode(3),
			...
			new AssignmentNode(new SelectorNode(new IdentNode(
				"ident1"), asList(new IdentNode("kp"))),
	...
	expected = new IfStatementNode(
		...
		new StatementSequenceNode(asList(new AssignmentNode(
			new SelectorNode(new IdentNode("ident1"),
				asList(new IdentNode("kp"))), new IntNode(10)))),
		new IfStatementNode(new BinOpNode(LO_OP, new IntNode(3),
			new IntNode(4)), new StatementSequenceNode(
			asList(new AssignmentNode(new SelectorNode(
				new IdentNode("ident1"), asList(new IdentNode(
					"kp"))), new IntNode(10)))), null, null),
		new StatementSequenceNode(asList(new AssignmentNode(
			new SelectorNode(new IdentNode("ident1"),
				asList(new IdentNode("kp"))), new IntNode(10)))));
	assertEquals(expected, actual);
	...
	expected = new IfStatementNode(new BinOpNode(HI_OP, new IntNode(10),
		new IntNode(5)), new StatementSequenceNode(
		asList(new AssignmentNode(new SelectorNode(new IdentNode(
			"ident1"), asList(new IdentNode("kp"))),
			new IntNode(10)))), null, new StatementSequenceNode(
		asList(new AssignmentNode(new SelectorNode(new IdentNode(
			"ident1"), asList(new IdentNode("kp"))),
			new IntNode(10)))));
	assertEquals(expected, actual);
	...
	actual = createParser("REPEAT ident1.kp:=10;PRINT h1 UNTIL 3 < 4")
		.repeatStatement();
	expected = new RepeatStatementNode(new StatementSequenceNode(asList(
		new AssignmentNode(new SelectorNode(new IdentNode("ident1"),
			asList(new IdentNode("kp"))), new IntNode(10)),
		new IdentNode("h1"))), new BinOpNode(LO_OP, new IntNode(3),
		new IntNode(4)));
	assertEquals(expected, actual);
    }
